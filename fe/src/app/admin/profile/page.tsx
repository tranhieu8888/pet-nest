...
const getPasswordStrength = (password: string) => {
  ...
  return { score, label: 'Mạnh', color: 'bg-indigo-500' };
};
...
const AdminProfilePage = () => {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 lg:p-6 w-full max-w-5xl mx-auto">
      {successMsg && (
        <div className="fixed top-20 left-1/2 z-50 -translate-x-1/2 rounded-xl bg-indigo-600 px-5 py-3 text-white shadow-lg">
          {successMsg}
        </div>
      )}
      ...
      <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="bg-gradient-to-r from-indigo-600 to-indigo-800 px-6 py-7 text-white md:px-8">
          <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold md:text-3xl">{userData.name || 'Tài khoản quản trị'}</h1>
                ...
                <div>
                  ...
                  {isEditing ? (
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-300 px-3 py-2.5 outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100"
                    />
                  ) : (
            ...
            {isEditing && (
              <div className="flex flex-col gap-3 sm:flex-row">
                <button
                  ...
                  className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-600 px-4 py-3 font-semibold text-white transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-70"
                >
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-4">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-lg border border-slate-300 px-3 py-2.5 pr-10 outline-none focus:border-indigo-500"
                      />
                      <button
                        type="button"
                        onClick={() =>
                  ...
                  <button
                    ...
                    className="w-full rounded-xl bg-indigo-600 px-4 py-2.5 font-semibold text-white transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-70"
                  >
